...
var DevicelatestWarningStatusSchema = new Schema({
...
const DevicelatestWarningStatus = mongoose.model("DevicelatestWarningStatus", DevicelatestWarningStatusSchema);

// DeviceInfo.watch().on("change", (data) => console.log(data));
module.exports = DevicelatestWarningStatus;
